...
$sql = "SELECT u.dni, u.nombre, u.contrasena, u.correo, u.telefono, d.pais, d.direccion, u.activo  FROM usuarios u JOIN direccion d ON u.id_direccion = d.id_direccion WHERE u.correo ='$correo'";
...
<body class="imagenAdmin">
    ...
    <div class="d-flex flex-column justify-content-center align-items-center mt-5" style="padding-left:120px;">
        <header class="fw-bold text-white fs-3 pb-3">Datos de cliente</header>
        <form class="p-3 rounded shadow" style="background-color: rgba(33, 37, 41, 0.6);" action="../conexiones/updateClient.php" method="POST">
